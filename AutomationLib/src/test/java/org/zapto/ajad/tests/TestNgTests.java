...
public class TestNgTests extends TestNgTestBase{
	...
	private HomePage homepage;
	  ...
	  public void initPageObjects() {
	    homepage = PageFactory.initElements(ObjWebDriver, HomePage.class);
	    loginpage = PageFactory.initElements(ObjWebDriver, LoginPage.class);
	    userhomepage = PageFactory.initElements(ObjWebDriver, UserHomePage.class);
	...
	public void testLoginPageValidate(String UserName, String PassWord){
		 ...
		 // loginpage.UserName.sendKeys("username");
		  ...
		  ObjWebDriver.get(StrUserHomeUrl);
		    ...
		    Assert.assertEquals("Welcome " + UserName , userhomepage.header.getText().toString(), "Pass");
	}
